...
# Different outputs
* There are six versions of this document. We will examine them, one by one:
  + *.Rmd*: The `R markdown` document. 
  + *.html*: A Wwbpage as we saw in the previous section. Follow workshop using this version. 
...
* Here is one I like for [manuscripts](https://github.com/svmiller/svm-r-markdown-templates/blob/master/svm-latex-ms.tex) (Thanks [svmiller](https://github.com/svmiller) on ![](../figures/octocat.png){width=40px})   
  ...
  + For example, using this (sligthly modified) template, I am writing my first [*.Rmd* manuscript](https://github.com/seb951/Acadian_seaplants/blob/master/manuscript_Rmd/Acadian_seaplants_v5.pdf).  
&nbsp;  
...
&nbsp;   
&nbsp;   
* Download and save template. Refer to it in the header. (Note however that you should download or at least take a look at the [*.Rmd*](https://github.com/svmiller/svm-r-markdown-templates/blob/master/svm-rmarkdown-article-example.Rmd) to see options available, and [*.pdf*](https://github.com/svmiller/svm-r-markdown-templates/blob/master/svm-rmarkdown-article-example.pdf) to see output.)   
...
* Note that in future version, *Radix* is now called [*distill*](https://github.com/rstudio/distill)
